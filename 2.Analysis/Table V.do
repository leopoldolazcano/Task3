...
log using "$analysis/QOB_V.log", replace 
...
esttab a1 a2 a3 a4 a5 a6 a7 a8 using "$analysis/table5.txt", b(%9.4fc) se(%9.4fc) keep(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) order(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) star(* 0.1 ** 0.05 *** 0.01) noobs replace
